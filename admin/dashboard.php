...
// gross start
// gross paid start
$table_gross_paid = $db->query("select sum(amount) as gross_earnings_archive from idevaff_archive where tracking not like '%fictive%'");
$table_gross_paid = $table_gross_paid->fetch();
$table_gross_paid_total = $table_gross_paid['gross_earnings_archive'];
$table_gross_paid = number_format($table_gross_paid['gross_earnings_archive'], $decimal_symbols);
if (1 === $cur_sym_location) {
    $table_gross_paid = $cur_sym.$table_gross_paid;
}

if (2 === $cur_sym_location) {
    $table_gross_paid = $table_gross_paid.' '.$cur_sym;
}

$table_gross_paid = $table_gross_paid.' '.$currency;
// gross paid end
// gross current start
$table_gross_total_app = $db->query("select sum(amount) as gcearnings_total from idevaff_sales where bonus = '0' and approved = '1' and tracking not like '%fictive%'");
$table_gross_total_app = $table_gross_total_app->fetch();
$table_gross_total_total = $table_gross_total_app['gcearnings_total'];
$table_gross_total_app = number_format($table_gross_total_app['gcearnings_total'], $decimal_symbols);
if (1 === $cur_sym_location) {
    $table_gross_total_app = $cur_sym.$table_gross_total_app;
}

if (2 === $cur_sym_location) {
    $table_gross_total_app = $table_gross_total_app.' '.$cur_sym;
}

$table_gross_curr_app = $table_gross_total_app.' '.$currency;
// gross current end
// gross total start
$table_gross_grand = number_format($table_gross_paid_total + $table_gross_total_total, $decimal_symbols);
if (1 === $cur_sym_location) {
    $table_gross_grand = $cur_sym.$table_gross_grand;
}

if (2 === $cur_sym_location) {
    $table_gross_grand = $table_gross_grand.' '.$cur_sym;
}

$table_gross_grand = $table_gross_grand.' '.$currency;
// gross total end
// gross end

// expenses start
$table_expenses = $db->query("select sum(amount) as expenses_total from idevaff_expenses");
$table_expenses = $table_expenses->fetch();
$table_expenses_num = $table_expenses['expenses_total'];
$table_expenses = number_format($table_expenses['expenses_total'], $decimal_symbols);
if (1 === $cur_sym_location) {
    $table_expenses = $cur_sym.$table_expenses;
}

if (2 === $cur_sym_location) {
    $table_expenses = $table_expenses.' '.$cur_sym;
}
$table_expenses = $table_expenses.' '.$currency;
// expenses end

// net start
$table_net = number_format($table_gross_paid_total - $table_expenses_num, $decimal_symbols);
if (1 === $cur_sym_location) {
    $table_net = $cur_sym.$table_net;
}

if (2 === $cur_sym_location) {
    $table_net = $table_net.' '.$cur_sym;
}

$table_net = $table_net.' '.$currency;
// gross total end
// net end
...
$net = $table_grand-$table_expenses;
...
echo "</div>\r\n</div>\r\n</div> \r\n</div>\r\n\r\n";
echo "<div class=\"col-sm-6 col-md-6 hidden-xs\">\r\n<div class=\"statbox widget box box-shadow\">\r\n<div class=\"widget-content\">\r\n<div class=\"visual orange\">\r\n<i class=\"icon-signal\"></i></div>\r\n<div class=\"title\">Gross Paid</div>\r\n<div class=\"value\">";
echo html_output($table_gross_paid);
echo "</div>\r\n</div>\r\n</div>\r\n</div>";
echo "<div class=\"col-sm-6 col-md-6 hidden-xs\">\r\n<div class=\"statbox widget box box-shadow\">\r\n<div class=\"widget-content\">\r\n<div class=\"visual cyan\">\r\n<i class=\"icon-signal\"></i></div>\r\n<div class=\"title\">Gross Current</div>\r\n<div class=\"value\">";
echo html_output($table_gross_curr_app);
echo "</div>\r\n</div>\r\n</div>\r\n</div>";
echo "<div class=\"col-sm-6 col-md-6 hidden-xs\">\r\n<div class=\"statbox widget box box-shadow\">\r\n<div class=\"widget-content\">\r\n<div class=\"visual red\">\r\n<i class=\"icon-signal\"></i></div>\r\n<div class=\"title\">Total Expenses</div>\r\n<div class=\"value\">";
echo html_output($table_expenses);
echo "</div>\r\n</div>\r\n</div>\r\n</div>";
echo "<div class=\"col-sm-6 col-md-6 hidden-xs\">\r\n<div class=\"statbox widget box box-shadow\">\r\n<div class=\"widget-content\">\r\n<div class=\"visual yellow\"><i class=\"icon-signal\"></i></div>\r\n<div class=\"title\">Current Tier Commissions</div>\r\n<div class=\"value\">";
...
echo "</div>\r\n</div>\r\n</div> \r\n</div> \r\n";
echo "<div class=\"col-sm-6 col-md-6 hidden-xs\" style=\"float:right;\">\r\n<div class=\"statbox widget box box-shadow\">\r\n<div class=\"widget-content\">\r\n<div class=\"visual purple\"><i class=\"icon-signal\"></i></div>\r\n<div class=\"title\">Gross Total</div>\r\n<div class=\"value\">";
echo html_output($table_gross_grand);
echo "</div>\r\n</div>\r\n</div> \r\n</div> \r\n";
echo "<div class=\"col-sm-6 col-md-6 hidden-xs\" style=\"float:right;\">\r\n<div class=\"statbox widget box box-shadow\">\r\n<div class=\"widget-content\">\r\n<div class=\"visual purple\"><i class=\"icon-signal\"></i></div>\r\n<div class=\"title\"><strong>Net (Gross Paid - Expenses)</strong></div>\r\n<div class=\"value\">";
echo html_output($table_net);
echo "</div>\r\n</div>\r\n</div> \r\n</div> \r\n";
echo "</div>\r\n\r\n";
if (1 === $show_map) {
