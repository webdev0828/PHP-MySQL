                            ...
                            <div class="portlet" style="border-color:{$portlet_4};">
                                <div class="portlet-heading" style="background:{$portlet_4};">
                                    <div class="portlet-title" style="color:{$portlet_4_text};">
                                        <h4>
                                            {$marketing_group_title}: {$etemplates_link_results[nr].etemplates_group_name}
                                        </h4>
                                    </div>
                                </div>
                                ...
                                <div class="portlet-body">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            ...
                                            {$etemplates_link_results[nr].etemplates_link_name}
                                        </li>
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <a href="{$etemplates_link_results[nr].etemplates_target_url}" target="_blank">
                                                {$etemplates_link_results[nr].etemplates_target_url}
                                            </a>
                                        </li>

                                        <li class="list-group-item">
                                            <a href="{$base_url}/eview.php?id={$etemplates_link_results[nr].etemplates_link_id}" class="btn btn-mini btn-primary fancy-page">
                                            ...
                                            <textarea rows="8" class="form-control" style="direction: ltr !important;">{$etemplates_link_results[nr].etemplates_box_code}</textarea>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <select name="etemplates_picked" class="form-control">
                                                    ...
                                                    <option value="{$etemplates_results[nr].etemplates_group_id}">
                                                        {$etemplates_results[nr].etemplates_group_name}
                                                    </option>
                                                    {/section}
                                                </select>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-3 col-sm-6">
                                                <button type="submit" class="btn btn-primary">
                                                    {$marketing_button} {$menu_etemplates}
                                                </button>
                                            </div>
                                        </div>
                                    </form>
