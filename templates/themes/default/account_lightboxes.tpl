                                    ...
                                    <div class="portlet-body">
                                        <ul class="list-group">
                                            <li class="list-group-item">
                                                ...
                                                <textarea rows="6" class="form-control" style="direction: ltr !important;"><link rel="stylesheet" href="{$install_url}/templates/source/lightbox/css/jquery.fancybox.css" type="text/css"/>
...
<script type="text/javascript" src="{$install_url}/templates/source/lightbox/js/fancy-custom.js"></script></textarea>
                                            ...
                                            <li class="list-group-item">
                                                <label>
                                                    <a href="https://www.idevlibrary.com/docs/Lightboxes.pdf" target="_blank" class="btn btn-mini btn-success">
                                                        {$lb_head_tutorial}
                                                    </a>
                                                </label>
                                            </li>
                                ...
                                <div class="portlet" style="border-color:{$portlet_4};">
                                    <div class="portlet-heading" style="background:{$portlet_4};">
                                        <div class="portlet-title" style="color:{$portlet_4_text};">
                                            <h4>{$marketing_group_title}: {$lightbox_link_results[nr].lightbox_group_name}</h4></div>
                                    </div>
                                    <div class="portlet-body">
                                        <ul class="list-group">
                                            <li class="list-group-item">
                                                ...
                                                {$lightbox_link_results[nr].lightbox_link_name}
                                            </li>
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                {$lightbox_link_results[nr].lightbox_description}
                                            </li>
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <a href="{$lightbox_link_results[nr].lightbox_target_url}" target="_blank">
                                                    {$lightbox_link_results[nr].lightbox_target_url}
                                                </a>
                                            </li>
                                            ...
                                            <li class="list-group-item">
                                                <a href="media/lightboxes/{$lightbox_link_results[nr].lightbox_image}" title="<a href='{$lightbox_link_results[nr].lightbox_link}' target='_blank'>{$lightbox_link_text}</a>" class="fancy-image">
                                                    <img src="media/lightboxes/{$lightbox_link_results[nr].lightbox_thumbnail}" width="{$lightbox_link_results[nr].lightbox_thumb_width}" height="{$lightbox_link_results[nr].lightbox_thumb_height}" style="border: none !important;" />
                                                </a>
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <textarea rows="4" class="form-control" style="direction: ltr !important;">{$lightbox_link_results[nr].lightbox_code}</textarea>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <select name="lb_picked" class="form-control">
                                                        ...
                                                        <option value="{$lb_results[nr].lb_group_id}">
                                                            {$lb_results[nr].lb_group_name}
                                                        </option>
                                                        {/section}
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-offset-3 col-sm-6">
                                                    <button type="submit" class="btn btn-primary">
                                                        {$marketing_button} {$menu_lightboxes}
                                                    </button>
                                                </div>
                                            </div>
                                        </form>
...
<script type="text/javascript" src="{$install_url}/templates/source/lightbox/js/fancy-custom.js"></script></textarea>
                                ...
                                <div class="col-md-12">
                                    <div class="portlet" style="border-color:{$portlet_4};">
                                        <div class="portlet-heading" style="background:{$portlet_4};">
                                            <div class="portlet-title" style="color:{$portlet_4_text};">
                                                <h4>
                                                    {$marketing_group_title}: {$lightbox_link_results[nr].lightbox_group_name}
                                                </h4>
                                            </div>
                                        </div>
                            ...
                            {else}
                            {* turn this text on if you want *} {* <legend style="color:{$legend};">{$marketing_no_group}</legend> *} {* <p>{$marketing_choose}</b><br/><br/><font style="color: #CC0000;">{$marketing_notice}</font></p> *}
                            {/if}
                    {/if}
                </div>
            </div>
