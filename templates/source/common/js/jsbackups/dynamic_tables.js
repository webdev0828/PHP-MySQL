...
$(document).ready(function() {
    ...
    if ($('#dyntable_Postbacks_Logs').length > 0) {
            ...
            "footerCallback": function ( row, data, start, end, display ) {
                ...
                alert('Welcome Str:: '+json);
                $('#status-filter').append('<option>' +data+ '</option>');
                $('#offer-filter').append('<option>' +data+ '</option>');
                $('#record-filter').append('<option>' +data+ '</option>');
                $('#method-filter').append('<option>' +data+ '</option>');
                $('#result-filter').append('<option>' +data+ '</option>');
                $('#http-filter').append('<option>' +data+ '</option>');
                $('#url-filter').append('<option>' +data+ '</option>');
            },
                ...
                $.ajax({
                    ...
                    success: function (info) {
                        ...
                        for (var g = 0; g < info.country.length; g++) {
                            ...
                            countryLi += "<li class='stats-child'><img border=\"0\" src=\"/images/geo_flags/" + data.n.toLowerCase() + ".png\" class=\"geo_flag\"/> " + data.n + "<span style='float:right;font-weight:700;'>" + data.v + "</span></li>"
                        ...
                        for (var g = 0; g < info.smart_tools.length; g++){
                            ...
                            toolsLi += "<li class='stats-child'>" + data.n + "<span style='float:right;font-weight:700;'>" + data.v + "</span></li>"
                        ...
                        for (var g = 0; g < info.offer_tools.length; g++){
                            ...
                            offerLi += "<li class='stats-child'>" + data.n + "<span style='float:right;font-weight:700;'>" + data.v + "</span></li>"
                        ...
                        for (var g = 0; g < info.sub_id.length; g++) {
                            ...
                            subIdLi += "<li class='stats-child'>" + data.n + "<span style='float:right;font-weight:700;'>" + data.v + "</span></li>"
                        ...
                        for (var g = 0; g < info.tid1.length; g++) {
                            ...
                            tid1Li += "<li class='stats-child'>" + data.n + "<span style='float:right;font-weight:700;'>" + data.v + "</span></li>"
                        ...
                        for (var g = 0; g < info.tid2.length; g++) {
                            ...
                            tid2Li += "<li class='stats-child'>" + data.n + "<span style='float:right;font-weight:700;'>" + data.v + "</span></li>"
                        ...
                        for (var g = 0; g < info.tid3.length; g++) {
                            ...
                            tid3Li += "<li class='stats-child'>" + data.n + "<span style='float:right;font-weight:700;'>" + data.v + "</span></li>"
                        ...
                        for (var g = 0; g < info.tid4.length; g++) {
                            ...
                            tid4Li += "<li class='stats-child'>" + data.n + "<span style='float:right;font-weight:700;'>" + data.v + "</span></li>"
                        ...
                        for (var g = 0; g < info.combinations.length; g++) {
                            ...
                            combinationsLi += "<li class='stats-child'>" + data.n + "<span style='float:right;font-weight:700;'>" + data.v + "</span></li>"
