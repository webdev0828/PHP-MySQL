...
// fetch on the next draw (i.e. `table.clearPipeline().draw()`)
            ...
            function formatDetails ( d ) {
                $.ajax({
                    ...
                    success: function (resp) {
                        ...
                        // TODO: add multiple postbacks start
                        /*
                        POST this to core_ajax_offers_detail.php
                        - e_postback_url
                        - e_postback_method
                        - e_postback_id
                        - e_postback_status
    ...
    $(document).ready(function() { \
    var max_postbacks = 9; \
    var wrapper = $(".postbacks"); \
    var add_button = $(".add_postback_portlet"); \
    var p_number = 1; \
    $(add_button).click(function(e) { \
        e.preventDefault(); \
        if (p_number < max_fields) { \
            p_number++; \
            $(wrapper).append(\'<div class=\"portlet\" style=\"border-color:#532B72;\">\
                                    <div class=\"portlet-heading\" style=\"background:linear-gradient(toright,rgba(0,0,0,0.40)0%,rgba(0,0,0,0)100%),#3A1259;\">\
                                        <div class=\"portlet-title\" style=\" color:#ffffff;\">\
                                            <h4>\
                                                <i class=\"fa fa-link fa fw\"></i>Offer '+d[10]+' Extra Action Notification \
                                            </h4>\
                                        </div>\
                                    </div>\
                            ...
                            <div class="form-group">\
                                ...
                                <div class="col-sm-1">\
                                    <label class="switch">\
                                        <input name="e_postback_status" type="checkbox" {if $e_postback_status) && $e_postback_status == 1}checked{/if}>\
                                        <span class=\"slider\"></span>\
                                    </label>\
                                </div>\
                                <label class="col-sm-1 control-label">Method</label>\
                                <div class="col-sm-1">\
                                    <select name="e_postback_method" class="form-control">\
                                        <option value="0" {if isset($e_postback_method) && $e_postback_method == 0}selected="selected"{/if}>GET</option>\
                                        <option value="1" {if isset($e_postback_method) && $e_postback_method == 1}selected="selected"{/if}>POST</option>\
                                    </select>\
                                </div>\
                            </div>\
                                        <div class=\"form-group\">\
                                            <label class=\"col-sm-1control-label\" style=\"font-weight:normal;\">URL</label>\
                                                <div class=\"col-sm-10\">\
                                                    <input type=\"text\" class=\"form-control\" name=\"e_postback_url[]\" size=\"60\" placeholder=\"XXX\" value=\"XXX\" maxlength=\"1024\">\
                                                </div>\
                                                <div class=\"col-sm-1\">\
                                                <input class=\"btn btn-primary\" name=\"save\" type=\" submit\" value=\"'+jstext.language.custom_submit+'\">\
                                                </div>\
                                            </div>\
                                    </div>\
                                </div>\
                                    <a href=\"#\" name="delete" class=\"delete btn btn-primary\">'+jstext.language.custom_delete+'</a></div>\
                            \'); \
        } else { \
            swal(" \'+jstext.language.custom_limit_is+ \'" " \' +max_postbacks+ "!")\
        } \
    }); \
    $(postbacks).on("click", ".delete", function(e) { \
        e.preventDefault(); \
        ...
        p_number--; \
                        ...
                        html += ('<div class="portlet banner-port" style="border-color: #532B72;" class="panel-collapse collapse"> \
                                    <div class="portlet-heading" style="background: linear-gradient(to right, rgba(0, 0, 0, 0.40) 0%, rgba(0, 0, 0, 0) 100%), #3A1259;"> \
                                        ...
                                        <div class="postbacks portlet-body collapse" id="postbacksholder-'+d[10]+'"> \
                                            <div class="postbacks"> \
                                    <button class="add_postback_portlet btn btn-primary">'+jstext.language.custom_add_new+' &nbsp; \
                                        <span style="font-size:16px; font-weight:bold;">+ </span> \
                                                ...
                                                <div class="portlet" style="border-color:#532B72;"> \
                                                    <div class="portlet-heading" style="background: linear-gradient(to right, rgba(0, 0, 0, 0.40) 0%, rgba(0, 0, 0, 0) 100%), #3A1259;"> \
                                                            <div class="portlet-title" style="color:#ffffff;"> \
                                                                <h4> \
                                                                    <i class="fa fa-link fa fw"></i> Offer '+d[10]+' Action Notification #1\
                                                                </h4> \
                                                            </div> \
                                                    </div> \
                                                    <div class="portlet-body"> \
                                                        <div class="form-group"> \
                                                            ...
                                                            <div class="col-sm-10"> \
                                                                <input type="text" class="form-control" name="e_postback_url[]" size="60" placeholder="URL Value" value="URL Value" maxlength="1024"> \
                                                            </div> \
                                                            <div class="col-sm-1"> \
                                                                <input class="btn btn-primary" type="submit" value="'+jstext.language.custom_submit+'"> \
                                                            </div> \
                                                        </div> \
                                                    </div> \
                                                </div> \
                        ...
                        // TODO: add multiple postbacks end
                        html += ('<div class="portlet banner-port" style="border-color: #532B72;" class="panel-collapse collapse"> \
                                <div class="portlet-heading" style="background: linear-gradient(to right, rgba(0, 0, 0, 0.40) 0%, rgba(0, 0, 0, 0) 100%), #3A1259;"> \
                                    <div class="portlet-title" style="color:#ffffff;"> \
                        ...
                        if(resp.link.length > 0) {
                            ...
                            <div class="row">\
                            <div class="col-md-4"><label>'+jstext.language.custom_filter_by_landing+'</label>' +
                                '<select class="form-control" id="landSelect'+d[10]+'"  onchange="filterLinks(' + d[10] + ',\'landChanged\')">' +
                            ...
                            if(resp.linktext.length > 0) {
                                html += '<div class="col-md-4"><label>'+jstext.language.custom_filter_by_landing+'</label>';
                                html += '<select class="form-control" id="linktextSelect' + d[10] + '" onchange="filterLinks(' + d[10] + ',\'linktextChanged\')">';
                            ...
                            if(resp.countries.length > 0) {
                                html += '<div class="col-md-4"><label>'+jstext.language.custom_filter_by_set+'</label>';
                                html += '<select class="form-control" id="linkCountriesSelect' + d[10] + '" onchange="filterLinks(' + d[10] + ',\'countryChanged\')">';
                                html += '<option value="" selected>' + jstext.language.custom_all + '</option>';
                                ...
                                html += '</div>'; // TODO: filter by country column from _links table + Filter only HOT
                        }
                        ...
                        $.each(resp.link,function (idx,data) {
                            ...
                            if(epc >= 0.3 && sr >= 0.3){
                                html+='<span class="label label-success">HOT</span> '+resp.data.name+' '+data.linktext+' '+data.country+' '+(data.land === 1 ? 'Landing' : 'Pre-landing')+' <span style="float:right">EPC: '+(data.hits === 0 ? (0).toFixed(4) : epc.toFixed(4))+' €</span> ';
                            }
                            else{
                                html+=''+resp.data.name+' '+data.linktext+' '+data.country+' '+(data.land === 1 ? 'Landing' : 'Pre-landing')+' <span style="float:right">EPC: '+(data.hits === 0 ? (0).toFixed(4) : epc.toFixed(4))+' €</span> ';
                            }
                            html +=('     </h4> \
                                    </div> \
                        ...
                        $.each(resp.banners,function (idx,data) {
                            ...
                            var sr=data.conv / data.hits * 100;
                            if(epc >= 0.3 && sr >= 0.3){
                                html += ('<h4><span class="label label-success">HOT</span> '+resp.data.name+' '+data.description+' '+data.size1+' x '+data.size2+' ('+data.language+') <span style="float:right"><span>EPC: '+(data.hits === 0 ? (0).toFixed(4) : epc.toFixed(4))+' €</span></h4>')
                            }
                            else{
                                html += ('<h4>'+resp.data.name+' '+data.description+' '+data.size1+' x '+data.size2+' ('+data.language+') <span style="float:right"><span>EPC: '+(data.hits === 0 ? (0).toFixed(4) : epc.toFixed(4))+' €</span></h4>')
                            }
                            html += '</div>'
                            html += '</div>'
        ...
        if ($('#dyntable_Stats').length > 0) {
            ...
            function format(d, type) {
                ...
                $.ajax({
                    ...
                    data: {startD: dates.startD, endD: dates.endD, info: infoT,aggregate:$('#aggregate').val(),current_date:d.actual_date},
                    dataType: 'json',
                    cache: false,
                    success: function (info) {
                        // Countries
                        // TODO: write case statements to display translatable child row name based on infoT
                        var filterCountry='<select class="js-example-basic-single form-control" onchange="statChildFilter(\''+trId+'\',\''+dates.startD+'\',\''+dates.endD+'\',\''+infoT+'\',\''+d.actual_date+'\')" name="country_filter" id="country_filter-'+trId+'">' +
                            '<option>All</option>';
                        var countryLi='';
                        ...
                        f += "</ul>"
                        //SubId
                        var filterSubId='<select class="js-example-basic-single form-control" onchange="statChildFilter(\''+trId+'\',\''+dates.startD+'\',\''+dates.endD+'\',\''+infoT+'\')" name="sub_id_filter" id="sub_id_filter-'+trId+'" >' +
                            '<option>All</option>';
                        var subIdLi='';
                        ...
                        f += "</ul>"
                        //Tid1
                        var filterTid1='<select class="js-example-basic-single form-control" onchange="statChildFilter(\''+trId+'\',\''+dates.startD+'\',\''+dates.endD+'\',\''+infoT+'\')" name="tid1_filter" id="tid1_filter-'+trId+'" >' +
                            '<option>All</option>';
                        var tid1Li='';
                        ...
                        f += "</ul>"
                        //Tid2
                        var filterTid2='<select class="js-example-basic-single form-control" onchange="statChildFilter(\''+trId+'\',\''+dates.startD+'\',\''+dates.endD+'\',\''+infoT+'\')" name="tid2_filter" id="tid2_filter-'+trId+'" >' +
                            '<option>All</option>';
                        var tid2Li='';
                        ...
                        f += "</ul>"
                        //Tid3
                        var filterTid3='<select class="js-example-basic-single form-control" onchange="statChildFilter(\''+trId+'\',\''+dates.startD+'\',\''+dates.endD+'\',\''+infoT+'\')" name="tid3_filter" id="tid3_filter-'+trId+'" >' +
                            '<option>All</option>';
                        var tid3Li='';
                        ...
                        f += "</ul>"
                        // Tid4
                        var filterTid4='<select class="js-example-basic-single form-control" onchange="statChildFilter(\''+trId+'\',\''+dates.startD+'\',\''+dates.endD+'\',\''+infoT+'\')" name="tid4_filter" id="tid4_filter-'+trId+'" >' +
                            '<option>All</option>';
                        var tid4Li='';
                        ...
                        // Tid combinations
                        var filterCombinations='<select class="js-example-basic-single form-control" onchange="statChildFilter(\''+trId+'\',\''+dates.startD+'\',\''+dates.endD+'\',\''+infoT+'\')" name="combinations_filter" id="combinations_filter-'+trId+'" >' +
                            '<option>All</option>';
                        var combinationsLi='';
                       ...
                       // Tools
                        var filterTools='<select class="js-example-basic-single form-control" onchange="statChildFilter(\''+trId+'\',\''+dates.startD+'\',\''+dates.endD+'\',\''+infoT+'\')" name="tools_filter" id="tools_filter-'+trId+'" >' +
                        ...
                        // Offer
                        var filterOffer='<select class="js-example-basic-single form-control" onchange="statChildFilter(\''+trId+'\',\''+dates.startD+'\',\''+dates.endD+'\',\''+infoT+'\')" name="offer_filter" id="offer_filter-'+trId+'" >' +
                                            '<option>All</option>';
                        var offerLi='';
...
function statChildFilter(trId, startD, endD, infoT, current_date){
    var trans = JSON.parse($("#trans").val());
    ...
    $.ajax({
        url: '/templates/internals/core_ajax_stats_detail.php',
        data: {startD: dates.startD, endD: dates.endD,current_date:current_date, info: infoT, country: country, subId: subId, tId1: tId1, tId2: tId2, tId3: tId3, tId4: tId4, combinations: combinations, smartTools: smartTools, offerTools: offerTools,aggregate:$('#aggregate').val()},
        dataType: 'json',
        cache: false,
        success: function (info) {
            // Countries
            // TODO: write case statements to display translatable child row name based on infoT
            var filterCountry='<select class="js-example-basic-single form-control" onchange="statChildFilter(\''+trId+'\',\''+dates.startD+'\',\''+dates.endD+'\',\''+infoT+'\')" name="country_filter" id="country_filter-'+trId+'">';
            var countryLi='';
            var f = "<div align='center'><h4>"+infoT+"</h4></div><ul class='col-sm-2 countries-r'><h4>" + trans.custom_country + "</h4>";
            for (var g = 0; g < info.country.length; g++) {
                var data = info.country[g];
