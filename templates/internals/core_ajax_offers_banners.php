...
try {
	...
	$paramRowPerPage = isset($_REQUEST['iDisplayBannersLength']) ? (int)$_REQUEST['iDisplayBanenrsLength'] : 9e13; // set to default 10 when pagination is enabled
	$paramStart = isset($_REQUEST['iDisplayBannersOffset']) ? (int)$_REQUEST['iDisplayBannersOffset'] : 0;
	$offerid = $_REQUEST['id'];
	...
	$queryString.="ORDER BY earnings / hits * 100 DESC, number ASC LIMIT ".$paramStart.",".$paramRowPerPage; // TODO: pagination
