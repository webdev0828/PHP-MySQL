...
if ( $country == "PL" ) { 
    $urls = array(
        "https://1d5e0e8bd73.traffic-c.com/?wid=12962&wid_hmac=ebca7e68fc5df5524a80710890c84822&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 12962 - PL-Tmobile-VIP  VIP IN-HOUSE 
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
