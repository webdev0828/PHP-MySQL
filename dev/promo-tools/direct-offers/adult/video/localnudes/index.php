...
if ( $country == "CL" ) { 
    $urls = array(
        "https://1d5e0e8bd73.traffic-c.com/?wid=14079&wid_hmac=edb1232cff727813c1066d3bf40b8b5f&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 14079 - CL-Entel-Local Nudes  HOT 
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
