...
if ( $country == "CH" ) { 
    $urls = array(
        "https://1d5e16f0473.traffic-c.com/?wid=12566&wid_hmac=b45715084913e2dbc25861952f879948&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 12566 - CH-Salt-XL69  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
