...
if ( $country == "CR" ) { 
    $urls = array(
        "https://1d5e0e8bd73.traffic-c.com/?wid=12191&wid_hmac=efa9dd107aaf7c007589c26dcd8db8fd&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 12191 - CR-Claro-Android-VIP 1  VIP  
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
