...
if ( $country == "BY" ) { 
    $urls = array(
        "https://1d5e16f0473.traffic-c.com/?wid=14354&wid_hmac=3f6c50d77fb078056a0f667182eef12c&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 14354 - BY-MTS-BestGames  HOT
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
