...
if ( $country == "QA" ) { 
    $urls = array(
        "https://1d5e162cf73.traffic-c.com/?wid=13017&wid_hmac=e1ff4f263f3b071610e517434280c4c2&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 13017 - QT-Ooredoo/Vodafone-Gamemob  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
