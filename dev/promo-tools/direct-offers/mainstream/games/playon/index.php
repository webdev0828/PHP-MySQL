...
if ( $country == "MM" ) { 
    $urls = array(
        "https://1d5e0e8bd73.traffic-c.com/?wid=14211&wid_hmac=a9abd6c847cc5006963cd685f0ad4c75&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 14211 - MM-Ooredoo-Playon  HOT 
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
