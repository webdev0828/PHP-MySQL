...
if ( $country == "KW" ) { 
    $urls = array(
        "https://1d5e15e3b93.traffic-c.com/?wid=14267&wid_hmac=7af5eab46989a3ed9e0e2baf50759635&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 14267 - KW-Ooredoo-X247  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
