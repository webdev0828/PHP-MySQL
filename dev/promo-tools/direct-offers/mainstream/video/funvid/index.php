...
if ( $country == "HU" ) { 
    $urls = array(
        "https://1d5e16d7dd3.traffic-c.com/?wid=12650&wid_hmac=5a3971e9939677f2466bc8839f82f0c9&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 12650 - HU-3G/WIFI-FunVid  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
