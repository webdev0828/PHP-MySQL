...
if ( $country == "IE" ) { 
    $urls = array(
        "https://1d5e16f0473.traffic-c.com/?wid=12552&wid_hmac=a834bcf2a2f76175cc72540c68232ebb&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 12552 - IE-3G/WIFI-Sweepstake-Click2sms  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
