...
if ( $country == "RU" ) { 
    $urls = array(
        "http://runetki2.com?c=614398&subid=$tracker&subid2=$country$delitel$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id", // BongaCash Runetki
    	"https://promo-bc.com/promo.php?type=direct_link&c=613965&page=random_model&subid=$tracker&subid2=$country$delitel$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id", // BongaCash Whitelabel Direct Model Random Chat
        "https://promo-bc.com/promo.php?type=direct_link&c=613963&page=popular_chat&subid=$tracker&subid2=$country$delitel$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id", // BongaCash Whitelabel Direct Model Popular Chat
        "http://sublimecam.com?c=613961&subid=$tracker&subid2=$country$delitel$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // BongaCash Whitelabel
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
