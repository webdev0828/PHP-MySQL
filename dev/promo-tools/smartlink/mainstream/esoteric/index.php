...
if ( $country == "BA" ) { 
    ...
    $urls = array(
        ...
        "https://gltrak.com/aff_c2.php?offer_id=1274&aff_id=10787&pid=86676&aff_sub=$tracker&aff_sub2=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id&source=desktop2&creative=smartlink&mbbr=1&pof=1&aof=1" // LV-BabaVanga-Desktop (ID: 1274)
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} elseif ( $country == "LT" ) { 
