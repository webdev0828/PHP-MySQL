...
$chcek_get_duplicate = $db->prepare('select record from idevaff_postbacks_logs where record = ? and result = 1 and postback_url = ? and method = 0 and status = 0');
...
$chcek_post_duplicate = $db->prepare('select record from idevaff_postbacks_logs where record = ? and result = 1 and postback_url = ? and method = 1 and status = 0');
