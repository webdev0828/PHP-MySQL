    ...
    <div class="row">
        <div class="col-md-12">
            <div class="portlet" style="border-color:{$portlet_5};">
                <div class="portlet-heading" style="background: linear-gradient(to right, rgba(0, 0, 0, 0.40) 0%, rgba(0, 0, 0, 0) 100%), {$portlet_5};">
                ...
                <div class="portlet-body">
                    ...
                    <form class="form-horizontal" role="form" method="post" action="private.php">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" placeholder="{$private_code_title}" name="signup_code" value="{if isset($signup_code)}{$signup_code}{/if}" />
                            </div>
                        </div>
