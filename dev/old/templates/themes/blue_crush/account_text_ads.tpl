    ...
    <div class="col-md-12">
        <div class="portlet portlet-basic">
            <div class="portlet-body">
                ...
                {if isset($one_click_delivery)} {section name=nr loop=$textad_link_results}
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="portlet-body">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <a href="{$textad_link_results[nr].textad_target_url}" target="_blank">{$textad_link_results[nr].textad_target_url}</a>
                                    </li>
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <textarea rows="14" class="form-control"><script type="text/javascript"><!-- 
iDevAffiliate_BoxWidth = "{$BoxWidth}"; 
iDevAffiliate_OutlineColor = "#{$OutlineColor}"; 
iDevAffiliate_TitleTextColor = "#{$TitleTextColor}"; 
iDevAffiliate_TitleTextBackgroundColor = "#{$TitleTextBackgroundColor}"; 
                        ...
                        <div class="portlet" style="border-color:{$portlet_3};">
                            <div class="portlet-heading" style="background: linear-gradient(to right, rgba(0, 0, 0, 0.40) 0%, rgba(0, 0, 0, 0) 100%), {$portlet_3};">
                                <div class="portlet-title" style="color:{$portlet_3_text};">
                                    <h4>{$choose_marketing_group}</h4></div>
                            </div>
                            <div class="portlet-body">
