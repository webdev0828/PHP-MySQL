                                ...
                                <div class="portlet-body">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            ...
                                            {$textlink_link_results[nr].textlink_link_text}
                                        </li>
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <a href="{$textlink_link_results[nr].textlink_target_url}" target="_blank"{$tl_rel_values}>
                                                {$textlink_link_results[nr].textlink_target_url}
                                            </a>
                                        </li>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="textlinks_picked" class="form-control">
                                                    ...
                                                    <option value="{$textlink_results[nr].textlink_group_id}">
                                                        {$textlink_results[nr].textlink_group_name}
                                                    </option>
                                                    {/section}
