                            ...
                            <div class="portlet" style="border-color:{$portlet_4};">
                                <div class="portlet-heading" style="background:{$portlet_4};">
                                    <div class="portlet-title" style="color:{$portlet_4_text};">
                                        <h4>
                                            {$marketing_group_title}: {$textad_link_results[nr].textad_group_name}
                                        </h4>
                                    </div>
                                </div>
                                ...
                                <div class="portlet-body">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            ...
                                            <a href="{$textad_link_results[nr].textad_target_url}" target="_blank">
                                                {$textad_link_results[nr].textad_target_url}
                                            </a>
                                        </li>
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <textarea rows="14" class="form-control" style="direction: ltr !important;"><script type="text/javascript"><!-- 
iDevAffiliate_BoxWidth = "{$BoxWidth}";
iDevAffiliate_OutlineColor = "#{$OutlineColor}";
iDevAffiliate_TitleTextColor = "#{$TitleTextColor}";
iDevAffiliate_TitleTextBackgroundColor = "#{$TitleTextBackgroundColor}";
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="textads_picked" class="form-control">
                                                    ...
                                                    <option value="{$textad_results[nr].textad_group_id}">
                                                        {$textad_results[nr].textad_group_name}
                                                    </option>
                                                    {/section}
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-3 col-sm-6">
                                                <button type="submit" class="btn btn-primary">
                                                    {$marketing_button} {$menu_text_ads}
                                                </button>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <div class="col-md-12">
                            <div class="portlet" style="border-color:{$portlet_4};">
                                <div class="portlet-heading" style="background:{$portlet_4};">
                                    <div class="portlet-title" style="color:{$portlet_4_text};">
                                        <h4>
                                            {$marketing_group_title}: {$textad_chosen_group_name}
                                        </h4>
                                    </div>
                                </div>
