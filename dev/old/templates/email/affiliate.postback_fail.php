...
$mail->isHTML(true);
$content = nl2br($con) . "<br /><br />Postback result: " . $result . "<br />Postback Call Date & Time: " . $date . "<br /><br />" . nl2br($signature);
} else {
$mail->isHTML(false);
$content = $con . "\n\Postback result: " . $result . "\Postback Call Date & Time: " . $date . "\n\n" . $signature;
}
