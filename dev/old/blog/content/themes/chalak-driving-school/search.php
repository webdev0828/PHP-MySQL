...
<div class="container">
	...
	<header class="page-header">
		<?php if ( have_posts() ) : ?>
			<h1 class="search-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Search Results for: %s','chalak-driving-school'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
		<?php else : ?>
			<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'chalak-driving-school' ); ?></h1>
		<?php endif; ?>
	</header>
				        ...
				        <div id="" class="content_area col-md-8 col-sm-8">
					    	<section id="post_section">
								...
								if ( have_posts() ) :
									...
									<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'chalak-driving-school' ); ?></p>
									<?php
										get_search_form();
