...
function comment_form( $args = array(), $post_id = null ) {
	...
	$fields   =  array(
		'author'  => '<p class="comment-form-author">' .
					 '<div class="input-group input-group-bg"><input style="height:5.5rem;" class="form-control" id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" maxlength="245"' . $html_req . ' /><i class="fa fa-user fa fw" aria-hidden="true"></i>
					</div></p>',
		'email'   => '<p class="comment-form-email">' .
					 '<div class="input-group input-group-bg"><input style="height:5.5rem;" class="form-control" id="email" name="email" ' . ( $html5 ? 'type="email"' : 'type="text"' ) . ' value="' . esc_attr( $commenter['comment_author_email'] ) . '" size="30" maxlength="100" aria-describedby="email-notes"' . $html_req . ' /><i class="fa fa-at fa fw" aria-hidden="true"></i>
					</div></p>',
		'url'     => '<p class="comment-form-url">' .
					 '<div class="input-group input-group-bg"><input style="height:5.5rem;" class="form-control" id="url" name="url" ' . ( $html5 ? 'type="url"' : 'type="text"' ) . ' value="' . esc_attr( $commenter['comment_author_url'] ) . '" size="30" maxlength="200" /><i class="fa fa-link fa fw" aria-hidden="true"></i>
					</div></p>',
	);
	...
	$defaults = array(
		'fields'               => $fields,
		'comment_field'        => '<p class="comment-form-comment"><div class="input-group input-group-bg"><textarea name="comment" cols="45" rows="6" maxlength="65525" required="required"></textarea><i class="fa fa-comments fa fw" aria-hidden="true" style="padding-top:2rem;padding-bottom:21.8rem;"></i></div></p>',
