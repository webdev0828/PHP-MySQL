...
if ( $country == "CZ" ) { 
    $urls = array(
        "https://gltrak.com/aff_c2.php?offer_id=1219&aff_id=10787&pid=78713&aff_sub=$tracker&aff_sub2=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id&source=mobile&creative=direct-offer&mbbr=1&pof=1&aof=1" // CZ-LaserSharpener-Desktop (ID: 1219) Direct Link
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} elseif ( $country == "IT" ) { 
    $urls = array(
        "https://gltrak.com/aff_c2.php?offer_id=1261&aff_id=10787&pid=83509&aff_sub=$tracker&aff_sub2=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id&source=mobile&creative=direct-offer&mbbr=1&pof=1&aof=1" // IT-LaserSharpener-Mobile (ID: 1261) Direct Link
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else { 
...
if ( $country == "CZ" ) { 
    $urls = array(
        "https://gltrak.com/aff_c2.php?offer_id=1219&aff_id=10787&pid=78713&aff_sub=$tracker&aff_sub2=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id&source=desktop&creative=direct-offer&mbbr=1&pof=1&aof=1" // CZ-LaserSharpener-Desktop (ID: 1219) Direct Link
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} elseif ( $country == "IT" ) { 
    $urls = array(
        "https://gltrak.com/aff_c2.php?offer_id=1260&aff_id=10787&pid=83508&aff_sub=$tracker&aff_sub2=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id&source=desktop&creative=direct-offer&mbbr=1&pof=1&aof=1" // IT-LaserSharpener-Desktop (ID: 1260) Direct Link
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
