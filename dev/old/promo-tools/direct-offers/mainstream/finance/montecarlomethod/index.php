...
if ( $country == "HR" && $link == "283" ) { 
    $urls = array(
        "https://gltrak.com/aff_c2.php?offer_id=1251&aff_id=10787&pid=82703&aff_sub=$tracker&aff_sub2=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id&source=mobile&creative=direct-offer&mbbr=1&pof=1&aof=1" // HR-MonteCarloMethod-Mobile (ID: 1251) Landing
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} elseif ( $country == "HR" && $link == "284" ) { 
    $urls = array(
        "https://gltrak.com/aff_c2.php?offer_id=1251&aff_id=10787&pid=82705&aff_sub=$tracker&aff_sub2=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id&source=mobile2&creative=direct-offer&mbbr=1&pof=1&aof=1" // HR-MonteCarloMethod-Mobile (ID: 1251) Pre-landing
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
...
if ( $country == "HR" && $link == "283" ) { 
    $urls = array(
        "https://gltrak.com/aff_c2.php?offer_id=1250&aff_id=10787&pid=82702&aff_sub=$tracker&aff_sub2=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id&source=desktop&creative=direct-offer&mbbr=1&pof=1&aof=1" // HR-MonteCarloMethod-Desktop (ID: 1250) Landing
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} elseif ( $country == "HR" && $link == "284" ) { 
    $urls = array(
        "https://gltrak.com/aff_c2.php?offer_id=1250&aff_id=10787&pid=82704&aff_sub=$tracker&aff_sub2=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id&source=desktop2&creative=direct-offer&mbbr=1&pof=1&aof=1" // HR-MonteCarloMethod-Desktop (ID: 1250) Pre-landing
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
