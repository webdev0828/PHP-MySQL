...
if ( $country == "IQ" ) { 
    $urls = array(
        "https://1d61673b5d3.traffic-c.com/?wid=14365&wid_hmac=6f6997f1fd01849178a8777d3dabe18f&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 14365 - IQ-Asiacell-SoccerContent  HOT
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
