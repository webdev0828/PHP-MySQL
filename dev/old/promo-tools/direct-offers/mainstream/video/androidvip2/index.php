...
if ( $country == "PL" ) { 
    $urls = array(
        "https://1d5e0e8bd73.traffic-c.com/?wid=13067&wid_hmac=d3b7cdf39e7fbc3a8ded259e46d9eff2&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 13067 - PL-Tmobile-Android-VIP 2  VIP IN-HOUSE 
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
