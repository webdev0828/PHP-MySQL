...
if ( $country == "AT" ) { 
    $urls = array(
        "https://1d5e16f0473.traffic-c.com/?wid=12558&wid_hmac=22ee96087409d528d0ff790535d1d4a4&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 12558 - AT-H3G-Funvid  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
