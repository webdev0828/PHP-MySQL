...
if ( $country == "HR" && $link == "237" ) { 
    $urls = array(
        "https://gltrak.com/aff_c2.php?offer_id=842&aff_id=10787&pid=57533&aff_sub=$tracker&aff_sub2=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id&source=mobile&creative=direct-offer&mbbr=1&pof=1&aof=1" // HR-EarAchePatch-Desktop (ID: 842) Direct Link
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} elseif ( $country == "HR" && $link == "238" ) { 
    $urls = array(
        "https://gltrak.com/aff_c2.php?offer_id=842&aff_id=10787&pid=57387&aff_sub=$tracker&aff_sub2=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id&source=mobile&creative=direct-offer&mbbr=1&pof=1&aof=1" // HR-EarAchePatch-Desktop (ID: 842) Pre-landing
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
...
if ( $country == "HR" && $link == "237" ) { 
    $urls = array(
        "https://gltrak.com/aff_c2.php?offer_id=842&aff_id=10787&pid=57533&aff_sub=$tracker&aff_sub2=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id&source=desktop&creative=direct-offer&mbbr=1&pof=1&aof=1" // HR-EarAchePatch-Desktop (ID: 842) Direct Link
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} elseif ( $country == "HR" && $link == "238" ) { 
    $urls = array(
        "https://gltrak.com/aff_c2.php?offer_id=842&aff_id=10787&pid=57387&aff_sub=$tracker&aff_sub2=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id&source=desktop&creative=direct-offer&mbbr=1&pof=1&aof=1" // HR-EarAchePatch-Desktop (ID: 842) Pre-landing
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
