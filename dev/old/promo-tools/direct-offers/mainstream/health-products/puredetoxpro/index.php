...
if ( $country == "HR" ) { 
    $urls = array(
        "https://gltrak.com/aff_c2.php?offer_id=855&aff_id=10787&pid=57093&aff_sub=$tracker&aff_sub2=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id&source=mobile&creative=direct-offer&mbbr=1&pof=1&aof=1" // HR-PureDetoxPro-Desktop (ID: 855) Landing
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
...
if ( $country == "HR" ) { 
    $urls = array(
        "https://gltrak.com/aff_c2.php?offer_id=855&aff_id=10787&pid=57093&aff_sub=$tracker&aff_sub2=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id&source=desktop&creative=direct-offer&mbbr=1&pof=1&aof=1" // HR-PureDetoxPro-Desktop (ID: 855) Landing
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
