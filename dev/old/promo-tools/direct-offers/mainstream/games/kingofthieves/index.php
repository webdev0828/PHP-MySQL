...
if ( $country == "MY" ) { 
    $urls = array(
        "https://1d5e0e8bd73.traffic-c.com/?wid=14195&wid_hmac=d2173baa12cb08c5da78d808488fc675&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 14195 - MY-Celcom-KingOfThieves  HOT  
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
