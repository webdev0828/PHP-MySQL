...
if ( $country == "DZ" ) { 
    $urls = array(
        "https://1d5e15e3b93.traffic-c.com/?wid=14204&wid_hmac=aefa5fc14e10022dc645ca1543fbbc1a&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 14204 - DZ-Ooredoo-UGZ  HOT
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
