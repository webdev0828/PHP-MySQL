...
if ( $country == "IQ" ) { 
    $urls = array(
        "https://1d5e1751ef3.traffic-c.com/?wid=14352&wid_hmac=5d305255547a540a376cf41f6fa45f28&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 14352 - IQ-Asiacell-PlayPortal  HOT
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
