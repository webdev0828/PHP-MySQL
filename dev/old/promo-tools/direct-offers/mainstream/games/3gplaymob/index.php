...
if ( $country == "PL" ) { 
    $urls = array(
        "https://1d5e162cf73.traffic-c.com/?wid=13871&wid_hmac=20c5c0b02cdccfde0edaa7da539f573b&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 13871 - PL-3G-Playmob  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
