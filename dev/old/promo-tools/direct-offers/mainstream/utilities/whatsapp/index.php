...
if ( $country == "GR" ) { 
    $urls = array(
        "https://1d5e16d7dd3.traffic-c.com/?wid=12887&wid_hmac=35a88489c5766e128d6bd83b7a5da013&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 12887 - GR-3G/Wifi-whatsapp  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
