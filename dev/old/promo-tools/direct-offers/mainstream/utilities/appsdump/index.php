...
if ( $country == "PT" ) { 
    $urls = array(
        "https://1d5e16d7dd3.traffic-c.com/?wid=12675&wid_hmac=1501f0f9c4e1bb9461a193646b224f8b&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 12675 - PT-Vodafone-NOS-MEO-Appdump  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
