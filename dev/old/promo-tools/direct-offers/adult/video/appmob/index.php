...
if ( $country == "IE" ) { 
    $urls = array(
        "https://1d5e0e8bd73.traffic-c.com/?wid=11785&wid_hmac=ec5e9712d495bd12c2c76e86533313fe&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 11785 - IE-Three-AppMob  HOT 
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
