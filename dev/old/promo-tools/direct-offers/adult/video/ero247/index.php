...
if ( $country == "PT" ) { 
    $urls = array(
        "https://1d5e15fc233.traffic-c.com/?wid=14246&wid_hmac=da76a8cbda72df6f2a97da0483187cfb&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 14246 - PT-NOS-Ero247  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
