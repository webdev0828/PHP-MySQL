...
if ( $country == "PT" ) { 
    $urls = array(
        "https://1d5e16f0473.traffic-c.com/?wid=12279&wid_hmac=542ec23a4477de7429ed2a1fb8c5c475&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 12279 - PT-Vodafone-MEO-Hornyhub  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
