...
if ( $country == "CL" ) { 
    $urls = array(
        "https://1d5e0e8bd73.traffic-c.com/?wid=13838&wid_hmac=884acc4f39c19157728a0c7a6f98d646&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 13838 - Chile-Entel-Android-VIP  VIP 
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
