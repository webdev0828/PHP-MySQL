...
if ( $country == "LK" ) { 
    $urls = array(
        "https://1d5e0e8bd73.traffic-c.com/?wid=11963&wid_hmac=d79f9229b3477ca0fa85d07c5ad055a7&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 11963 - LK-Mobitel-Android-VIP  VIP 
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
