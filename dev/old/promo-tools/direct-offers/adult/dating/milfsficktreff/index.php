...
if ( $country == "AT" && $link == "205" ) { // badoo
    $urls = array(
        "https://1d5e162cf73.traffic-c.com/?wid=13316&wid_hmac=ab51a68a033f9ff08c2a7224bd71c2ff&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 13316 - DE/AT/CH-Mobile-Milfsficktreff-ReifeSexbadoo  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} elseif ( $country == "AT" && $link == "206" ) { // dating
    $urls = array(
        "https://1d5e162cf73.traffic-c.com/?wid=13313&wid_hmac=90f24e7002004cdedd4563c51b0f383c&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 13313 - DE/AT/CH-Mobile-Milfsficktreff-Dating  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
}elseif ( $country == "AT" && $link == "207" ) { // suchen
    $urls = array(
        "https://1d5e162cf73.traffic-c.com/?wid=13312&wid_hmac=ca21a2536bfdc2cfba183295c2cc8e0b&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 13312 - DE/AT/CH-Mobile-Milfsficktreff-Suchen  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
}elseif ( $country == "DE" && $link == "205" ) { // badoo
    $urls = array(
        "https://1d5e162cf73.traffic-c.com/?wid=13316&wid_hmac=ab51a68a033f9ff08c2a7224bd71c2ff&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 13316 - DE/AT/CH-Mobile-Milfsficktreff-ReifeSexbadoo  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
}elseif ( $country == "DE" && $link == "206" ) { // dating
    $urls = array(
        "https://1d5e162cf73.traffic-c.com/?wid=13313&wid_hmac=90f24e7002004cdedd4563c51b0f383c&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 13313 - DE/AT/CH-Mobile-Milfsficktreff-Dating  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
}elseif ( $country == "DE" && $link == "207" ) { // suchen
    $urls = array(
        "https://1d5e162cf73.traffic-c.com/?wid=13312&wid_hmac=ca21a2536bfdc2cfba183295c2cc8e0b&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 13312 - DE/AT/CH-Mobile-Milfsficktreff-Suchen  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
}elseif ( $country == "CH" && $link == "205" ) { // badoo
    $urls = array(
        "https://1d5e162cf73.traffic-c.com/?wid=13316&wid_hmac=ab51a68a033f9ff08c2a7224bd71c2ff&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 13316 - DE/AT/CH-Mobile-Milfsficktreff-ReifeSexbadoo  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
}elseif ( $country == "CH" && $link == "206" ) { // dating
    $urls = array(
        "https://1d5e162cf73.traffic-c.com/?wid=13313&wid_hmac=90f24e7002004cdedd4563c51b0f383c&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 13313 - DE/AT/CH-Mobile-Milfsficktreff-Dating  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
}elseif ( $country == "CH" && $link == "207" ) { // suchen
    $urls = array(
        "https://1d5e162cf73.traffic-c.com/?wid=13312&wid_hmac=ca21a2536bfdc2cfba183295c2cc8e0b&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 13312 - DE/AT/CH-Mobile-Milfsficktreff-Suchen  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
...
if ( $country == "AT" && $link == "205" ) { // badoo
    $urls = array(
        "https://1d5e162cf73.traffic-c.com/?wid=13317&wid_hmac=a8d8fcf8cbdbaf90df3b464b8db8b69c&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 13317 - DE/AT/CH-Desktop-Milfsficktreff-Sexbadoo  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} elseif ( $country == "AT" && $link == "206" ) { // dating
    $urls = array(
        "https://1d5e162cf73.traffic-c.com/?wid=13315&wid_hmac=bac1362c28e27e7d6b6829ee4111fd52&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 13315 - DE/AT/CH-Desktop-Milfsficktreff-Dating  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
}elseif ( $country == "AT" && $link == "207" ) { // suchen
    $urls = array(
        "https://1d5e162cf73.traffic-c.com/?wid=13314&wid_hmac=c202262faf689d776f5281a9f8629cb5&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 13314 - DE/AT/CH-Desktop-Milfsficktreff-Suchen  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
}elseif ( $country == "DE" && $link == "205" ) { // badoo
