...
if ( $country == "DE" && $link == "226" ) { 
    $urls = array(
        "https://1d5e16d7dd3.traffic-c.com/?wid=12022&wid_hmac=7df52af145387b45612d5a5f7480e043&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 12022 - DE/AT/CH-Mobile-Fremdfickzone-Fortfahren  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} elseif ( $country == "AT" && $link == "226" ) { 
    $urls = array(
        "https://1d5e16d7dd3.traffic-c.com/?wid=12022&wid_hmac=7df52af145387b45612d5a5f7480e043&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 12022 - DE/AT/CH-Mobile-Fremdfickzone-Fortfahren  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} elseif ( $country == "CH" && $link == "226" ) { 
    $urls = array(
        "https://1d5e16d7dd3.traffic-c.com/?wid=12022&wid_hmac=7df52af145387b45612d5a5f7480e043&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 12022 - DE/AT/CH-Mobile-Fremdfickzone-Fortfahren  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} elseif ( $country == "DE" && $link == "227" ) { 
    $urls = array(
        "https://1d5e16d7dd3.traffic-c.com/?wid=12021&wid_hmac=5b7e8a9c72ad45b7e43f6b078619b7e6&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 12021 - DE/AT/CH-Mobile-Fremdfickzone-Warnung  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} elseif ( $country == "AT" && $link == "227" ) { 
    $urls = array(
        "https://1d5e16d7dd3.traffic-c.com/?wid=12021&wid_hmac=5b7e8a9c72ad45b7e43f6b078619b7e6&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 12021 - DE/AT/CH-Mobile-Fremdfickzone-Warnung  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} elseif ( $country == "CH" && $link == "227" ) { 
    $urls = array(
        "https://1d5e16d7dd3.traffic-c.com/?wid=12021&wid_hmac=5b7e8a9c72ad45b7e43f6b078619b7e6&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 12021 - DE/AT/CH-Mobile-Fremdfickzone-Warnung  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
...
if ( $country == "DE" && $link == "226" ) { 
    $urls = array(
        "https://1d5e16d7dd3.traffic-c.com/?wid=12637&wid_hmac=5bf12eecc1bf5c22df8810d994d2dc8f&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 12637 - DE/AT/CH-Desktop-Fremdfickzone-Fortfahren  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} elseif ( $country == "AT" && $link == "226" ) { 
    ...
    $urls = array(
        "https://1d5e16d7dd3.traffic-c.com/?wid=12636&wid_hmac=392a841820d46ad883f86cb083289f07&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 12636 - DE/AT/CH-Desktop-Fremdfickzone-Warnung  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} elseif ( $country == "AT" && $link == "227" ) { 
