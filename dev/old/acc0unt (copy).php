...
$smarty->assign('aff_lvl_percent', $levelamt);
...
// paid
    ...
    $table_stats .= '[ "' . date('Y/m/d', strtotime('-' . $l . ' days')) . '", "' . $chart_traffic_raw . '", "' . $chart_traffic . '", "' . $chart_commissions . '", "' . $sales_ratio_rounded . '%", "' . $chart_sales_totals . '€", "' . $chart_sales_totals_paid . '€" ],';

    $chart_array_graph .= "{ d: '" . date('Y/m/d', strtotime('-' . $l . ' days')) . "', a: " . $chart_traffic . ', b: ' . $chart_commissions . ', e: ' . $sales_ratio_rounded . ', c: ' . $chart_sales_totals . ' },';
