...
<div id="preloader">
    <div id="loader" class="dots-jump">
        ...
        <div></div>
            ...
            <div class="home-content" style="display:block;" align="center">
        <div class="home-content__main">
            <a href="/"><img src="/images/logo_big.png" alt="Sublime Revenue - Up To 80% Commission Per Action Network"></a> 
        </div>
            </div>
...
<?php echo qtranxf_generateLanguageSelectCode(‘both’); ?>
                ...
                <ul class="header-nav__list">
                    ...
                    <li><a href="/signup" title="<?php echo __('[:en]Signup Now[:ru]Регистрация'); ?>" style="color:#532B72;"><i
                                    class="fa fa-user-plus fa-fw"></i> <?php echo __('[:en]Signup Now[:ru]Регистрация'); ?></a></li>
                    ...
                    <li><a href="/contact" title="<?php echo __('[:en]Contact Us[:ru]Связаться с нами'); ?>"><i
