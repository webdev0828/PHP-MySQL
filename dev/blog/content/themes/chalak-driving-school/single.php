					    	...
					    	<section id="post_section">
								...
								while ( have_posts() ) : the_post();
									...
									the_post_navigation( array(
										'prev_text' => '<span class="screen-reader-text">' . __( 'Previous Post', 'chalak-driving-school' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Previous', 'chalak-driving-school' ) . '</span>',
										'next_text' => '<span class="screen-reader-text">' . __( 'Next Post', 'chalak-driving-school' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Next', 'chalak-driving-school' ) . '</span> ',
									) );
