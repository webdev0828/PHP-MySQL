                ...
                $.ajax({
                    ...
                    success: function (resp) {
                        ...
                        if(resp.link.length > 0) {
                            ...
                            <div class="row">\
                            <div class="col-md-3">' + // TODO: add All option on filters
                                '<select class="link-type" id="landSelect'+d[10]+'"  onchange="filterLinks(' + d[10] + ',\'landChanged\')">' +
                            ...
                            if(resp.linktext.length > 1) {
                                ...
                                html += '<select class="link-set" id="linktextSelect' + d[10] + '" onchange="filterLinks(' + d[10] + ',\'linktextChanged\')">';
                        ...
                        if(resp.banners.length > 0) {
                            ...
                            <div><div class="row">'
                            html += '<div class="col-md-4"><label id="descriptionLabel'+ d[10] +'"';
                            ...
                            html += '<div class="col-md-1"><label id="size1Label'+ d[10] +'"';
                            ...
                            html += '<div class="col-md-1"><label id="size2Label'+ d[10] +'"';
    ...
    if ($('#dyntable_Postbacks_Logs').length > 0) {
            ...
            initComplete: function (oSettings,json) {
                ...
                $.each(json.availableMethods,function (idx,method) {
                    if (method == '0') {
                        $('#method-filter').append('<option value="1">GET</option>')
                    } else {
                        $('#method-filter').append('<option value="0">POST</option>')
                    }
                })
