                ...
                $.ajax({
                    ...
                    success: function (resp) {
                        ...
                        if(resp.link.length > 0) {
                            ...
                            html += '<div class="text-right" style="margin-right:1.8rem;"><div class="dataTables_length" id="dyntable_Offers_links_length"><label> <select name="dyntable_Offers_length" aria-controls="dyntable_Offers" class="custom-select custom-select-sm form-control form-control-sm select2-hidden-accessible" data-select2-id="16" tabindex="-1" aria-hidden="true"><option value="10" data-select2-id="18">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="17" style="width: 100px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-dyntable_Offers_length-y7-container"><span class="select2-selection__rendered" id="select2-dyntable_Offers_length-y7-container" role="textbox" aria-readonly="true" title="10"><span class="select2-selection__clear" data-select2-id="19">×</span>10</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span></label></div></div>\
                            </div> '; // TODO: Filter only HOT and Running, not important
                        }
                        ...
                        html += ' </div> \
<div class="row">\
<!-- work with resp.link values, limit and offset -->\
    <div class="col-sm-auto">\
        <div class="dataTables_info" id="dyntable_Offers_links_info" role="status" aria-live="polite">\
            Showing 1 to X of Y entries\
        </div>\
    </div>\
        <div class="dataTables_paginate paging_bootstrap" id="dyntable_Offers_links_paginate">\
            <ul class="pagination">\
                ...
                <li class="next"><a href="#">Next → </a></li>\
                        ...
                        if(resp.banners.length > 0) {
                            ...
                            html += '<div class="text-right" style="margin-right:1.8rem;"><div class="dataTables_length" id="dyntable_Offers_banners_length"><label> <select name="dyntable_Offers_length" aria-controls="dyntable_Offers" class="custom-select custom-select-sm form-control form-control-sm select2-hidden-accessible" data-select2-id="16" tabindex="-1" aria-hidden="true"><option value="10" data-select2-id="18">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="17" style="width: 100px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-dyntable_Offers_length-y7-container"><span class="select2-selection__rendered" id="select2-dyntable_Offers_length-y7-container" role="textbox" aria-readonly="true" title="10"><span class="select2-selection__clear" data-select2-id="19">×</span>10</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span></label></div></div>\
                            </div>';
                        }
...
<div class="row">\
<!-- work with resp.banners values, limit and offset -->\
    <div class="col-sm-auto">\
        <div class="dataTables_info" id="dyntable_Offers_banners_info" role="status" aria-live="polite">\
            Showing 1 to X of Y entries\
        </div>\
    </div>\
        <div class="dataTables_paginate paging_bootstrap" id="dyntable_Offers_banners_paginate">\
            <ul class="pagination">\
                <li class="prev disabled"><a href="#">← Previous</a></li>\
                <li class="active"><a href="#">1</a></li><li><a href="#">2</a></li>\
                <li><a href="#">3</a></li>\
