...
// }
	...
	$query = $db->prepare('SELECT * FROM idevaff_banners WHERE grp = :id ORDER BY earnings / hits * 100 DESC, number ASC'); // TODO: pagination
	$query->execute(array(
		':id'=>$offerid
	));
	...
	$queryLinks = $db->prepare('SELECT * FROM idevaff_links WHERE grp = :id ORDER BY earnings / hits * 100 DESC, id ASC'); // TODO: pagination
