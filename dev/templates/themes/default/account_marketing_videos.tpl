                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="mv_picked" class="form-control">
                                                    ...
                                                    <option value="{$mv_results[nr].mv_group_id}">
                                                        {$mv_results[nr].mv_group_name}
                                                    </option>
                                                    {/section}
                        ...
                        <div class="col-md-12">
                            <div class="portlet" style="border-color:{$portlet_4};">
                                <div class="portlet-heading" style="background:{$portlet_4};">
                                    ...
                                    <div class="pull-right" style="color:{$portlet_4_text};">
                                        {$mv_head_description}
                                    </div>
                                </div>
                                ...
                                <div class="portlet-body">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            ...
                                            {$mvideos_link_results[nr].mvideos_link_name}

                                            <span class="{if $language_direction == '1' }pull-left{else}pull-right{/if}">
                                                <a href="video_preview.php?affiliate_id={$link_id}&video_id={$mvideos_link_results[nr].mvideos_link_id}" class="btn btn-success btn-sm" target="_blank">
                                                    {$mv_preview_button}
                                                </a>
                                            </span>
                                        </li>
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <a href="{$mvideos_link_results[nr].mvideos_target_url}" target="_blank">
                                                {$mvideos_link_results[nr].mvideos_target_url}
                                            </a>
                                        </li>
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <textarea rows="8" class="form-control" style="direction: ltr !important;"><!-- External CSS Libraries -->
<link rel="stylesheet" href="{$install_url}/templates/source/videos/css/elite.css" type="text/css" media="screen"/>
...
<script type="text/javascript" src="{$install_url}/video.php?id={$link_id}&video_id={$mvideos_link_results[nr].mvideos_link_id}"></script></textarea>
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <textarea rows="2" class="form-control" style="direction: ltr !important;"><div id="idev_video_player"></div></textarea>
                                        </li>
                                    </ul>
                                </div>
                            </div>
