                                ...
                                <div class="portlet" style="border-color:{$portlet_4};">
                                    <div class="portlet-heading" style="background:{$portlet_4};">
                                        <div class="portlet-title" style="color:{$portlet_4_text};">
                                            <h4>
                                                {$marketing_group_title}: {$html_link_results[nr].html_group_name}
                                            </h4>
                                        </div>
                                    </div>
                                    ...
                                    <div class="portlet-body">
                                        <ul class="list-group">
                                            <li class="list-group-item">
                                                ...
                                                {$html_link_results[nr].html_link_name}
                                            </li>
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <a href="{$html_link_results[nr].html_target_url}" target="_blank">
                                                    {$html_link_results[nr].html_target_url}
                                                </a>
                                            </li>

                                            <li class="list-group-item">
                                                <label style="width: 100% !important;">
                                                    <a href="{$base_url}/adview.php?id={$html_link_results[nr].html_link_id}" target="_blank" class="btn btn-mini btn-primary fancy-page">
                                                        {$html_view_link}
                                                    </a>
                                                ...
                                                <textarea rows="8" class="form-control" style="direction: ltr !important;">{$html_link_results[nr].html_link_url}</textarea>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <select name="html_picked" class="form-control">
                                                        ...
                                                        <option value="{$htmlad_results[nr].htmlad_group_id}">
                                                            {$htmlad_results[nr].htmlad_group_name}
                                                        </option>
                                                        {/section}
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-offset-3 col-sm-6">
                                                    <button type="submit" class="btn btn-primary">
                                                        {$marketing_button} {$menu_html_links}
                                                    </button>
                                                </div>
                                            </div>
                                        </form>
                                ...
                                <div class="col-md-12">
                                    <div class="portlet" style="border-color:{$portlet_4};">
                                        <div class="portlet-heading" style="background:{$portlet_4};">
                                            <div class="portlet-title" style="color:{$portlet_4_text};">
                                                <h4>
                                                    {$marketing_group_title}: {$html_chosen_group_name}
                                                </h4>
                                            </div>
                                        </div>
