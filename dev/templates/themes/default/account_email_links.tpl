                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <select name="email_picked" class="form-control">
                                                    ...
                                                    <option value="{$email_results[nr].email_group_id}">
                                                        {$email_results[nr].email_group_name}
                                                    </option>
                                                    {/section}
                                                </select>
                            ...
                            <div class="portlet" style="border-color:{$portlet_4};">
                                <div class="portlet-heading" style="background:{$portlet_4};">
                                    <div class="portlet-title" style="color:{$portlet_4_text};">
                                        <h4>
                                            {$marketing_group_title}: {$email_chosen_group_name}
                                        </h4>
                                    </div>
                                </div>
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class="alert alert-info">
                                                ...
                                                <br/>
                                                <textarea rows="2" class="form-control"  style="direction: ltr !important;">{$email_chosen_url}</textarea>
                                                <br />
                                                    {$email_source}
                                                <br />
                                            </div>
                                        ...
                                        <li class="list-group-item">
                                            <div class="alert alert-warning">
                                                ...
                                                <textarea rows="2" class="form-control" style="direction: ltr !important;"><a href="{$email_chosen_url}{$rel_values}">{$email_chosen_group_name}</a></textarea>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="portlet" style="border-color:{$portlet_5};">
                                ...
                                <div class="portlet-body">
                                    {$email_test}: 
                                    <a href="{$email_chosen_url}{$rel_values}" target="_blank">
                                        {$email_chosen_display_tag}
                                    </a>
                                    <br/>
                                    <br/>
                                    {$email_test_info}
