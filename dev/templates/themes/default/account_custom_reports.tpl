                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <select name='tid1' class='form-control'>
                                    ...
                                    <option value='{$get1_results[nr].tid1_value}'>
                                        {$get1_results[nr].tid1_value}
                                    </option>
                                    {/section}
                            ...
                            <div class="col-md-6">
                                <select name='tid2' class='form-control'>
                                    ...
                                    <option value='{$get2_results[nr].tid2_value}'>
                                        {$get2_results[nr].tid2_value}
                                    </option>
                                    {/section}
                        ...
                        <div class="row" style="margin-top: 25px !important;">
                            <div class="col-md-6">
                                <select name='tid3' class='form-control'>
                                    ...
                                    <option value='{$get3_results[nr].tid3_value}'>
                                        {$get3_results[nr].tid3_value}
                                    </option>
                                    {/section}
                            ...
                            <div class="col-md-6">
                                <select name='tid4' class='form-control'>
                                    ...
                                    <option value='{$get4_results[nr].tid4_value}'>
                                        {$get4_results[nr].tid4_value}
                                    </option>
                                    {/section}
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="portlet" style="border-color:{$portlet_1};">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <form method="POST" action="export/export.php">
                                ...
                                <tr>
                                    <td width="60%">
                                        {$report_results[nr].report_keywords}
                                    </td>
                                    <td width="15%">
                ...
                <div class="portlet-body">
                    <font color="#CC0000">{$cr_no_results}</font>
                    <br/>
                    {$cr_no_results_info}
                </div>
                {/if}
