        ...
        <div class="portlet portlet-basic">
            <div class="portlet-body">
                        ...
                        <div class="portlet" style="border-color:{$portlet_4};">
                            <div class="portlet-heading" style="background:{$portlet_4};">
                                <div class="portlet-title" style="color:{$portlet_4_text};">
                                    <h4>
                                        {$marketing_group_title}: {$banner_link_results[nr].banner_group_name}
                                    </h4>
                                </div>
                            </div>
                            ...
                            <div class="portlet-body">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        ...
                                        {$banner_link_results[nr].banner_size_1}x {$banner_link_results[nr].banner_size_2}
                                    </li>
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        {$banner_link_results[nr].banner_description}
                                    </li>
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <a href="{$banner_link_results[nr].banner_target_url}" target="_blank">
                                            {$banner_link_results[nr].banner_target_url}
                                        </a>
                                    </li>

                                    <li class="list-group-item">
                                        <label style="width: 100% !important;">
                                            {$banner_link_results[nr].banner_display}
                                            <br/>
                                            <br/>
                                            {$marketing_source_code}
                                        </label>
                                        <br/>
                                        <textarea rows="4" class="form-control" style="direction: ltr !important;">{$banner_link_results[nr].banner_code}</textarea>
                                    </li>
                ...
                {else}
                                ...
                                <div class="portlet-body">
                                    <form class="form-horizontal" role="form" method="post" action="account.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6"><select name="banner_picked" class="form-control">
                        ...
                        <div class="col-md-12">
                            <div class="portlet" style="border-color:{$portlet_4};">
                                <div class="portlet-heading" style="background:{$portlet_4};">
                                    <div class="portlet-title" style="color:{$portlet_4_text};">
                                        <h4>
                                            {$marketing_group_title}: {$banner_chosen_group_name}
                                        </h4>
                                    </div>
                                </div>
                    ...
                    {/section}
                    {else}
                        {* turn this text on if you want *} {* <h5>{$marketing_no_group}</h5> *} {* {$marketing_choose}<BR /><BR /><font color="#CC0000">{$marketing_notice}</font> *}
                    {/if}
                {/if}
            </div>
        </div>
