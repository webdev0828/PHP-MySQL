                            ...
                            <div class="portlet" style="border-color:{$portlet_4};">
                                ...
                                <div class="portlet-body">
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item">
                                            <label>{$qr_image}</label>
                                        </li>
                                        
                                        <li class="list-group-item">
                                            <label>{$qr_code_offline_title}</label>
                                        ...
                                        <li class="list-group-item">
                                            <label style="width:100%;">{$qr_code_online_title}</label>
                                            ...
                                            <br/>
                                            <br/> 
                                            <textarea rows="4" class="form-control"><a href="{$url_only}" target="_blank"><img src="{$base_url}{$image_only}" style="border:none;" height="{$size_only}" width="{$size_only}"/></a></textarea>
                                        </li>
