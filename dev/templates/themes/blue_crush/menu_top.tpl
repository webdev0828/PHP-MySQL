        ...
        <div class="navbar-inner {if !isset($cp_page_width)} container{/if}">
            <div class="navbar-header">
                ...
                <div class="navbar-brand col-md-12">
                    {if isset($main_logo)}
                    <a href="index.php" class="brand"><img class="img-responsive" style="border:none;" src="{$main_logo}" alt="{$sitename} - {$header_title}"></a>
                    {/if}
                </div>
            </div>
            ...
            <div class="nav-top">
                ...
                <ul class="nav lang navbar-right {if isset($cp_fixed_navbar)}mobileFix{/if}">
                    <li class="dropdown" style="background-color: {$top_menu_background};">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <span class="user-info" style="color: {$top_menu_text};">{$language_selected}</span> 
                            <b class="caret"></b>
                        </a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="#" onclick="document.getElementById('idev_language').value = '{$language_pack[nr].value}'; document.getElementById('language_form').submit(); return false;">{$language_pack[nr].name}</a>
                            </li>
                ...
                <ul class="nav user-information navbar-right {if isset($cp_fixed_navbar)}mobileFix{/if}">
                    <li class="dropdown" style="background-color: {$top_menu_background};">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <span class="user-info" style="color: {$top_menu_text};">{$affiliate_firstname} {$affiliate_lastname}</span> 
                            <b class="caret"></b>
                        </a>
                ...
                <div class="collapse navbar-collapse top-collapse mobileFix">
                    <ul class="nav navbar-left navbar-nav">
                        <li style="background-color: {$top_menu_background};">
                            <a href="index.php">
                                <span style="color: {$top_menu_text};">{$header_indexLink}</span>
                            </a>
                        </li>
                        
                        <li style="background-color: {$top_menu_background};">
                            <a href="account.php">
                                <span style="color: {$top_menu_text};">{$header_accountLink}</span>
                            </a>
                        </li>
                        ...
                        <li style="background-color: {$top_menu_background};">
                            <a href="signup.php">
                                <span style="color: {$top_menu_text};">{$header_signupLink}</span>
                            </a>
                        </li>
                        {/if}
                        ...
                        <li style="background-color: {$top_menu_background};">
                            <a href="contact.php">
                                <span style="color: {$top_menu_text};">{$header_emailLink}</span>
                            </a>
                        </li>
                        {/if}
                        ...
                        <li style="background-color: {$top_menu_background};">
                            <a href="faq.php">
                                <span style="color: {$top_menu_text};">{$menu_faq}</span>
                            </a>
                        </li>
                        {/if}
                        ...
                        <li style="background-color: {$top_menu_background};">
                            <a href="testimonials.php">
                                <span style="color: {$top_menu_text};">{$header_testimonials}</span>
                            </a>
                        </li>
                        {/if}
