...
// works for Zetaniche, SlimSpots and TrafficCompany | DONE - TEST
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://sublimerevenue.com/q8GfuAqBtoDwD0AIsU_OLD.php?idev_ordernum=".$idev_ordernum."&idev_saleamt=".$eur."&affiliate_id=".$aff_id."&tids=".$tids."&geo=".$geo);
