...
$sub_id = $pieces[8];
            ...
            $data = array($pieces[5], $payout, $setme, $ip_addr, $commission_time, $idev_ordernum, $avar, $ov1, $ov2, $ov3, $type, $split, $profile, $delay_insert, $r_url, $sub_id, $pieces[1], $pieces[2], $pieces[3], $pieces[4], $target_url, $currency_to_write, $converted_amount, $pieces[0], $tracking_method_used, $diff, $alternate_amount, $sliding_scale, $sliding_alternate, $per_product_used, $src1, $src2);
            $statement->execute($data);
