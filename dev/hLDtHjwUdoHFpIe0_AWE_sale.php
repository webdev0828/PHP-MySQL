...
$pieces=explode("RkwuK6", $clickid);
            ...
            $data = array($idev, $payout, $setme, $ip_addr, $commission_time, $idev_ordernum, $avar, $ov1, $ov2, $ov3, $type, $split, $profile, $delay_insert, $r_url, $pieces[2], $pieces[3], $pieces[4], $pieces[5], $pieces[6], $target_url, $currency_to_write, $converted_amount, $pieces[1], $tracking_method_used, $diff, $alternate_amount, $sliding_scale, $sliding_alternate, $per_product_used, $src1, $src2);
            $statement->execute($data);
