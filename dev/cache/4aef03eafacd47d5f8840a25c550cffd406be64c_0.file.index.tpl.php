<?php
/* Smarty version 3.1.30, created on 2019-04-08 15:28:41
  from "/var/www/sublimerevenue.com/dev/templates/themes/SublimeRevenue/index.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5cab68a96f06e0_86910025',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4aef03eafacd47d5f8840a25c550cffd406be64c' => 
    array (
      0 => '/var/www/sublimerevenue.com/dev/templates/themes/SublimeRevenue/index.tpl',
      1 => 1554498288,
      2 => 'file',
    ),
  ),
...
function content_5cab68a96f06e0_86910025 (Smarty_Internal_Template $_smarty_tpl) {
...
if (!is_callable('smarty_function_math')) require_once '/var/www/sublimerevenue.com/dev/templates/smarty/plugins/function.math.php';
?>
...
"><i
                                class="far fa-user-circle fa-fw"></i> <?php echo $_smarty_tpl->tpl_vars['custom_advertisers']->value;?>
</a></li>
                <li><a class="smoothscroll" href="#statistics" title="<?php echo $_smarty_tpl->tpl_vars['custom_statistics']->value;?>
"><i
                                class="fas fa-chart-bar fa-fw"></i> <?php echo $_smarty_tpl->tpl_vars['custom_statistics']->value;?>
</a></li>
    ...
    <div class="row bit-narrow advertisers block-1-2 block-tab-full">
        ...
        <div class="col-block item-service" data-aos="fade-up">
            <div class="item-service__icon">
                <i style="text-shadow: none !important;" class="fa fa-star fa-fw" style="color:#532B72;"></i>
            </div>
        ...
        <div class="col-block item-service" data-aos="fade-up">
            <div class="item-service__icon">
                <i style="text-shadow: none !important;" class="fa fa-code fa-fw" style="color:#532B72;"></i>
            </div>
            <div class="item-service__text">
...
<section id="statistics" class="s-statistics target-section">
    ...
    <?php if (isset($_smarty_tpl->tpl_vars['bar_comms_last_6']->value) || isset($_smarty_tpl->tpl_vars['pie_top_5_month']->value)) {?>
        <div class="row bit-narrow advertisers block-1-2 block-tab-full">
            ...
            <div class="col-block item-service" data-aos="fade-up">
                <div class="item-service__icon">
                    <i style="text-shadow: none !important;" class="fa fa-calendar-alt fa-fw" style="color:#532B72;"></i>
                </div>
                <div class="item-service__text">
...
echo smarty_function_math(array('equation'=>"round( x / y ) * y",'x'=>$_prefixVariable4,'y'=>5),$_smarty_tpl);
 ...
 €</span></div>
                    <strong><i style="text-shadow: none !important;" class="fa fa-globe fa-fw"></i> <?php echo $_smarty_tpl->tpl_vars['custom_global']->value;?>
</strong> 
                    </li>
                </ul>
                <!--
...
: <?php echo $_smarty_tpl->tpl_vars['c_epc_l6m_t']->value;?>
            ...
            <div class="col-block item-service" data-aos="fade-up">
                <div class="item-service__icon">
                        <i style="text-shadow: none !important;" class="fa fa-calendar-check fa-fw " style="color:#532B72;"></i>
                </div>
                <div class="item-service__text">
...
: <?php echo $_smarty_tpl->tpl_vars['c_sr_tm_t']->value;?>
            ...
            <div class="col-block item-service" data-aos="fade-up">
                <div class="item-service__icon">
                    <i style="text-shadow: none !important;" class="fa fa-chart-pie fa-fw" style="color:#532B72;"></i>
                </div>
                <div class="item-service__text">
...
>
            ...
            <div class="col-full item-service" data-aos="fade-up">
                <div class="item-service__icon">
                    <i style="text-shadow: none !important;" class="fa fa-chart-bar fa-fw" style="color:#532B72;"></i>
                </div>
                <div class="item-service__text">
...
',
                                            a: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[0]['payouts'];?>
'
                                        }, {
                                            x: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[1]['name'];?>
',
                                            a: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[1]['payouts'];?>
'
                                        }, {
                                            x: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[2]['name'];?>
',
                                            a: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[2]['payouts'];?>
'
                                        }, {
                                            x: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[3]['name'];?>
',
                                            a: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[3]['payouts'];?>
'
                                        }, {
                                            x: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[4]['name'];?>
',
                                            a: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[4]['payouts'];?>
'
                                        }, {
                                            x: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[5]['name'];?>
',
                                            a: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[5]['payouts'];?>
'
                                        }, {
                                            x: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[6]['name'];?>
',
                                            a: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[6]['payouts'];?>
'
                                        }, {
                                            x: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[7]['name'];?>
',
                                            a: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[7]['payouts'];?>
'
                                        }, {
                                            x: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[8]['name'];?>
',
                                            a: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[8]['payouts'];?>
'
                                        }, {
                                            x: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[9]['name'];?>
',
                                            a: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[9]['payouts'];?>
'
                                        }, {
                                            x: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[10]['name'];?>
',
                                            a: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[10]['payouts'];?>
'
                                        }, {
                                            x: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[11]['name'];?>
',
                                            a: '<?php echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[11]['payouts'];?>
'
                                        },],
                                        stacked: 'yes',
                                        xkey: 'x',
...
', 'Amounts Paid'],
                                        yLabelFormat: function (a) { return a.toLocaleString() + ' €'; },
...
>
                                ...
                                <div class="morris-hover-row-label">
                                    <?php ob_start();
echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[0]['payouts'];
$_prefixVariable13=ob_get_clean();
ob_start();
echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[1]['payouts'];
$_prefixVariable14=ob_get_clean();
ob_start();
echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[2]['payouts'];
$_prefixVariable15=ob_get_clean();
ob_start();
echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[3]['payouts'];
$_prefixVariable16=ob_get_clean();
ob_start();
echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[4]['payouts'];
$_prefixVariable17=ob_get_clean();
ob_start();
echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[5]['payouts'];
$_prefixVariable18=ob_get_clean();
ob_start();
echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[6]['payouts'];
$_prefixVariable19=ob_get_clean();
ob_start();
echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[7]['payouts'];
$_prefixVariable20=ob_get_clean();
ob_start();
echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[8]['payouts'];
$_prefixVariable21=ob_get_clean();
ob_start();
echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[9]['payouts'];
$_prefixVariable22=ob_get_clean();
ob_start();
echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[10]['payouts'];
$_prefixVariable23=ob_get_clean();
ob_start();
echo $_smarty_tpl->tpl_vars['monthly_commissions']->value[11]['payouts'];
$_prefixVariable24=ob_get_clean();
ob_start();
echo smarty_function_math(array('equation'=>"(a + b + c + d + e + f + g + h + i + j + k + l)",'a'=>$_prefixVariable13,'b'=>$_prefixVariable14,'c'=>$_prefixVariable15,'d'=>$_prefixVariable16,'e'=>$_prefixVariable17,'f'=>$_prefixVariable18,'g'=>$_prefixVariable19,'h'=>$_prefixVariable20,'i'=>$_prefixVariable21,'j'=>$_prefixVariable22,'k'=>$_prefixVariable23,'l'=>$_prefixVariable24),$_smarty_tpl);
$_prefixVariable25=ob_get_clean();
$_smarty_tpl->_assignInScope('total_paid', number_format($_prefixVariable25,2,".",","));
?>
                                    <?php echo $_smarty_tpl->tpl_vars['custom_total']->value;?>
 <?php echo $_smarty_tpl->tpl_vars['chart_last_6_months']->value;?>
: <?php echo $_smarty_tpl->tpl_vars['total_paid']->value;?>
 €
                                </div>
                            </div>
                        </div>
...
<div class="addthis_inline_follow_toolbox" style="margin: auto;width: 184px;"></div>
            ...
            <p class="contact-address" style="font-size:1.5rem;">
                Countess Cat Inc. <br />
                <i style="text-shadow: none !important;" class="fa fa-map-marker fa-fw"></i> Global Gateway 8, Rue de la Perle, Providence, Mahe, Seychelles
            </p>
        </div>
    </div>
