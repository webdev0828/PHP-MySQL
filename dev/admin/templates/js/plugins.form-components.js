...
var FormComponents = function() {
	...
	var resizeEventSelect2 = function() {
		// ToDo!
		//$('*').select2('destroy');
	}
	...
	var handleResizeEvent = function() {
		var resizeLayout = _.debounce(_resizeEvents, 50);
		$(window).resize(resizeLayout);
	}

	// Executed only every 50ms
	var _resizeEvents = function() {
		resizeEventSelect2(); // Select2
	}
	...
	return {
		...
		init: function () {
			...
			handleResizeEvent(); // Few plugins (e.g. select2) need to be updated on resize
		}
