...
function content_5cac424d3a4f47_03180802 (Smarty_Internal_Template $_smarty_tpl) {
...
" type="hidden"/>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <select name="textlinks_picked" class="form-control" id="smartlinks-select" style="width:100%">
                                                        <option></option>
                                                        <?php
...
" maxlength="64">
                                        <i class="fa fa-hashtag fa fw" aria-hidden="true" style="text-shadow: none !important;"></i>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
...
if ($_prefixVariable1 >= 0.3 && $_prefixVariable2 >= 0.3) {?>
                                                ...
                                                <?php ob_start();
echo $_smarty_tpl->tpl_vars['textlink_link_results']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_nr']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_nr']->value['index'] : null)]['textlink_grp'];
...
$(document).ready(function() {
    $('#smartlinks-select').select2({placeholder: "<?php echo $_smarty_tpl->tpl_vars['custom_niche']->value;?>
",allowClear: true});
});
<?php echo '</script'; ?>
>
