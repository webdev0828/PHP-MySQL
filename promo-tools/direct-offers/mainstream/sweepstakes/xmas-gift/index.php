...
if ( $country == "NZ" ) { 
    $urls = array(
        "https://1d5e17211b3.traffic-c.com/?wid=13897&wid_hmac=1414d6c48b51a6bc5a49a28180573385&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 13897 - NZ-3G/WiFi-XmasGift
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} elseif ( $country == "AU" ) { 
    $urls = array(
        "https://1d5e17211b3.traffic-c.com/?wid=13896&wid_hmac=67267b392d2d461889337bdff38833f5&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 13896 - AU-3G/WiFi-XmasGift
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} elseif ( $country == "SG" ) { 
    $urls = array(
        "https://1d5e17211b3.traffic-c.com/?wid=13893&wid_hmac=e1394e2c94b36d6bf27494af38a93c32&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 13893 - SG-3G/WiFi-XmasGift
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
