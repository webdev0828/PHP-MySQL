...
if ( $country == "DE" ) { 
    $urls = array(
        "https://1d5e162cf73.traffic-c.com/?wid=13185&wid_hmac=e9836f098ad9fba18643f82eaf4413d9&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 13185 - DE-Vodafone-Madfun  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
