...
if ( $country == "CH" ) { 
    $urls = array(
        "https://1d5e16f0473.traffic-c.com/?wid=12564&wid_hmac=5632c6ae268b1defe272d58ea2c9084b&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 12564 - CH-Salt-2app  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
