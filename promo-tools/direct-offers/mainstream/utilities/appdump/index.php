...
if ( $country == "PT" ) { 
    $urls = array(
        "https://1d5e15fc233.traffic-c.com/?wid=14244&wid_hmac=a1543e231c17691ed4d17500519c044b&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // 14244 - PT-NOS-Appdump  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
