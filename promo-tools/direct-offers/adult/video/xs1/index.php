...
if ( $country == "CH" ) { 
    $urls = array(
        "https://1d5e16d7dd3.traffic-c.com/?wid=12846&wid_hmac=505c04e938e1b3c0506511a2c7598db7&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 12846 - CH-Salt-XS1  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
