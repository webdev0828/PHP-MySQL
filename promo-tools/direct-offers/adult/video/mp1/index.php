...
if ( $country == "PT" ) { 
    $urls = array(
        "https://1d5e15fc233.traffic-c.com/?wid=14245&wid_hmac=178da8d46650f4bbbd0cfadb1e51149e&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 14245 - PT-NOS-MP1  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
