...
if ( $country == "IE" ) { 
    $urls = array(
        "https://1d5e0e8bd73.traffic-c.com/?wid=12299&wid_hmac=862a179d40888f4451f8258d881970eb&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 12299 - IE-Three-Android-VIP 2  VIP 
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
