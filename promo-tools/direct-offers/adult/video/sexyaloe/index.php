...
if ( $country == "IT" ) { 
    $urls = array(
        "https://1d5e1708b13.traffic-c.com/?wid=14309&wid_hmac=724a35d22bb33a1b2ec06d4aa889f947&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 14309 - IT-TIM-SEXYALOE  HOT
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
