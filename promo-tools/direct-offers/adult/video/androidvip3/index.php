...
if ( $country == "CL" ) { 
    $urls = array(
        "https://1d5e0e8bd73.traffic-c.com/?wid=13905&wid_hmac=6ad6ce6d8766df51bb977a41eccc11fd&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 13905 - CL-Entel-Android-VIP 2  VIP 
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
