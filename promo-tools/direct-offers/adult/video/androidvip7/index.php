...
if ( $country == "HN" ) { 
    $urls = array(
        "https://1d5e0e8bd73.traffic-c.com/?wid=11995&wid_hmac=a1c751b41659a16b93b5c37c49f8ce2b&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 11995 - HN-Claro-Android-VIP  VIP  
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
