...
if ( $country == "HU" ) { 
    $urls = array(
        "https://1d5e16d7dd3.traffic-c.com/?wid=12649&wid_hmac=4a6a1276b531dec4df4ebda14da02c2b&p=5221&pi=$tracker&click_id=$tid11$delitel$tid22$delitel$tid33$delitel$tid44$delitel$set$delitel$link$delitel$sub_id" // TC 12649 - HU-3G/WIFI-Hotvid  IN-HOUSE
    );
    $url = $urls[array_rand($urls)];
    checkUrl($url, $urls);
} else {
